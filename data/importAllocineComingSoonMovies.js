...
var jsonfailedRequestsComingSoonMovies = "./save/tmp/failedRequestsComingSoonMovies.json";
...
var movieInfo = [];
var failedRequestsComingSoonMovies = [];
let ids = [];
var simonGenre = [];
  ...
  if (i === moviesAllocineComingSoon.length) {
    ...
    setTimeout(
      function() {
        ...
        jsonfile.writeFile(
          jsonfailedRequestsComingSoonMovies,
          failedRequestsComingSoonMovies,
          function(err) {
            if (err !== null) {
              console.error(err);
            } else {
              console.log(
                "JSON saved with " +
                  failedRequestsComingSoonMovies.length +
